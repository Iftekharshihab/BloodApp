...
/*            showDialog(
            ...
            children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon:IconButton(
                            ...
                            icon:  _isvisiable ? Icon(Icons.visibility,size: 22,color: Colors.grey,) : Icon(Icons.visibility_off,size: 22,color: Colors.grey,),
                          ),
                          contentPadding: EdgeInsets.only(left: 15,top: 10),
                        ),
                        validator: (value){
             ...
             InkWell(
                onTap: () async{
                  ...
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  child:  Text("Registration",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
              ...
              Row(
                ...
                children: [
                  Text("Already have an account?",style: TextStyle(fontSize: 18,color: Colors.grey),),
                  TextButton(
                    onPressed: (){
  ...
  void registration (var ref)async{
    ...
    authenticationService.SignUp(
      ...
      if(value!.isNotEmpty){
        var response = await Doner_Firebase_Crud.signUpDoner(
          img_url: image_url ?? " ",
        ...
        if(response.code == 200){
          //-----------------------------Easy loading---------
          EasyLoading.showSuccess("User Registration Success");
          ...
          EasyLoading.showError("User Registration Failed");
