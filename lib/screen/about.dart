    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10,),
          Text("' হারুর রক্তে বেঁচেছে হারুন, রহিম দিয়েছে রাম কে, সামান্য দান অসামান্য হয় রক্ত বাঁচায় প্রাণ কে।'",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: ColorsResource.COLOR_PRIMARY),),
          SizedBox(height: 10,),
